...
Revision ID: 53fc50601f8e
Revises: 
Create Date: 2023-02-10 16:10:55.466283
...
def upgrade():
    ...
    sa.Column('hate_receiver_id', sa.Integer(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('admirer_id', sa.Integer(), nullable=False),
    sa.Column('like_receiver_id', sa.Integer(), nullable=False),
